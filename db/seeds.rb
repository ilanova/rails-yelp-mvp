...
dishoom = { name: 'Dishoom', address: '12 Upper St Martins Ln, West End, London', phone_number: '+44 20 7420 9320', category: 'chinese'}
as = { name: 'As du falafel', address: '34, rue de Rosier 75004 Paris', phone_number: '+33 01 48 87 63 60', category: 'french'}
